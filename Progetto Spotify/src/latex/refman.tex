...
\vspace*{7cm}
\begin{center}%
{\Large Progetto\+Spotify \\[1ex]\large 1.\+0.\+4 }\\
\vspace*{1cm}
...
\chapter{Progetto Universitario Spotify}
...
\input{struct_a_r_t_i_s_t_a}
\input{struct_d_a_t_a}
\input{struct_u_t_e_n_t_e}
\chapter{Documentazione dei file}
\input{funzioni_8c}
\input{funzioni_8h}
\input{funzioni__artista_8c}
\input{funzioni__utente_8c}
\input{main_8c}
